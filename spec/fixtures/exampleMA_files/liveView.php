...
var SekindoClientDetections_URL = function (config) {
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=106594&cbuster=1654817090',
					origQString: 's=106594',
					placementId: 106594,
					x: 400,
					y: 225,
					videoType: 'sticky',
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"Linux","osVersion":"","osVersionMajor":"0","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Chrome","browserType":"browser","browserVersion":"102.0.5005.61","browserVersionMajor":"102","browserVersionMinor":"0","chromeVersion":"102"},"browser":"chrome","os":"linux","osVer":"","deviceType":"desktop","languages":{"0":"pt","2":"en"},"googlePSI":false},
					isFpCookie: 0,
					geo: 'BR',
					dmaCode: 0,
					dynamicSetup: [],
