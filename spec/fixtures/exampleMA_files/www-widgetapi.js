...
c.prototype=b.prototype;a.O=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.Tb=function(d,e,f){for(var g=Array(arguments.length-2),h=2;h<arguments.length;h++)g[h-2]=arguments[h];return b.prototype[e].apply(d,g)}}
...
return a}
var Id={Bb:"allow-forms",Cb:"allow-modals",Db:"allow-orientation-lock",Eb:"allow-pointer-lock",Fb:"allow-popups",Gb:"allow-popups-to-escape-sandbox",Hb:"allow-presentation",Ib:"allow-same-origin",Jb:"allow-scripts",Kb:"allow-top-navigation",Lb:"allow-top-navigation-by-user-activation"},Kd=bb(function(){return Jd()});
...
for(var e=[],f=[],g=[],h=[128],k=1;64>k;++k)h[k]=0;var l,m;a();return{reset:a,update:c,digest:d,ob:function(){for(var q=d(),t="",p=0;p<q.length;p++)t+="0123456789ABCDEF".charAt(Math.floor(q[p]/16))+"0123456789ABCDEF".charAt(q[p]%16);return t}}}
...
function Wd(a){var b=Td();b.update(a);return b.ob().toLowerCase()}
...
return k}
;var yi={Qb:"WEB_DISPLAY_MODE_UNKNOWN",Mb:"WEB_DISPLAY_MODE_BROWSER",Ob:"WEB_DISPLAY_MODE_MINIMAL_UI",Pb:"WEB_DISPLAY_MODE_STANDALONE",Nb:"WEB_DISPLAY_MODE_FULLSCREEN"};function zi(){if(!A.matchMedia)return"WEB_DISPLAY_MODE_UNKNOWN";try{return A.matchMedia("(display-mode: standalone)").matches?"WEB_DISPLAY_MODE_STANDALONE":A.matchMedia("(display-mode: minimal-ui)").matches?"WEB_DISPLAY_MODE_MINIMAL_UI":A.matchMedia("(display-mode: fullscreen)").matches?"WEB_DISPLAY_MODE_FULLSCREEN":A.matchMedia("(display-mode: browser)").matches?"WEB_DISPLAY_MODE_BROWSER":"WEB_DISPLAY_MODE_UNKNOWN"}catch(a){return"WEB_DISPLAY_MODE_UNKNOWN"}}
...
function Ni(a,b,c){c=void 0===c?{}:c;var d={};O("enable_web_eom_visitor_data")&&N("EOM_VISITOR_DATA")?d={"X-Goog-EOM-Visitor-Id":N("EOM_VISITOR_DATA")}:d={"X-Goog-Visitor-Id":c.visitorData||N("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.Sb||N("AUTHORIZATION"))||(a?b="Bearer "+B("gapi.auth.getToken")().Rb:b=be([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=N("SESSION_INDEX",0),O("pageid_as_header_web")&&(d["X-Goog-PageId"]=N("DELEGATED_SESSION_ID")));return d}
...
a);
if("AbortError"===e.name)return new T("UNKNOWN_ABORT",a,e.message);e.args=[Object.assign({},a,{name:"IdbError",Wb:e.name})];e.level="WARNING";return e}
...
var g=void 0!==b?self.indexedDB.open(a,b):self.indexedDB.open(a);var h=c.blocked,k=c.blocking,l=c.zb,m=c.upgrade,q=c.closed,t;g.addEventListener("upgradeneeded",function(p){try{if(null===p.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");if(null===g.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");p.dataLoss&&"none"!==p.dataLoss&&ij("IDB_DATA_CORRUPTED",{reason:p.dataLossMessage||"unknown reason",dbName:nj(a)});var y=f(),z=new Oj(g.transaction);
...
closed:c,zb:c,upgrade:a.options.upgrade};var e=b();a.i=e;return a.i}
...
function ol(a){nl(a)&&!a.ha&&(a.i=!0,a.va&&Math.random()<=a.ta&&a.F.nb(a.A),pl(a),a.H.G()&&a.na(),a.H.S(a.Ja,a.na.bind(a)),a.H.S(a.Ia,a.Pa.bind(a)))}
...
n.wb=function(a){!O("use_shared_nsm")&&(this.m=!0,void 0===a?0:a)&&(this.pa||bm(this))};
n.Da=function(){var a=window.navigator.onLine;return void 0===a?!0:a};
n.pb=function(){this.C=!0};
...
function jn(a,b,c,d,e){return{retry:!0,onSuccess:c,onError:d,ab:a,ga:b,Ub:!!e,headers:{},postBodyFormat:"",postBody:""}}
...
b,c.qb&&delete on[c.ma]);(c.yb?bn:Wm)({endpoint:"log_event",payload:e,R:c.R,ga:c.ga},d)}}
...
0;X<Kn.length&&!(va=Bn(Kn[X],"params.context."+X,p,va),500<=va);X++);navigator.vendor&&!p.hasOwnProperty("vendor")&&(p["device.vendor"]=navigator.vendor);var S={message:z,name:G,lineNumber:P,fileName:kb,stack:uc,params:p,sampleWeight:1},Rj=Number(t.columnNumber);isNaN(Rj)||(S.lineNumber=S.lineNumber+":"+Rj);if("IGNORED"===t.level)m=0;else a:{for(var Sj=xn(),Tj=u(Sj.Y),Qf=Tj.next();!Qf.done;Qf=Tj.next()){var Uj=Qf.value;if(S.message&&S.message.match(Uj.Vb)){m=Uj.weight;break a}}for(var Vj=u(Sj.W),
...
value:wk}),Xb.kvPairs.push({key:"server.version",value:xk}));Xf={errorMetadata:Xb,stackTrace:po,logMessage:gg}}var yk=Xf;if(!yk)break a;rn("clientError",yk)}if("ERROR"===Gc||O("errors_flush_gel_always_killswitch"))b:{if(O("web_fp_via_jspb")&&(pn(!0),!O("web_fp_via_jspb_and_json")))break b;pn()}}if(!O("suppress_error_204_logging")){var tb=ra,Ic=tb.params||{},$a={urlParams:{a:"logerror",t:"jserror",type:tb.name,msg:tb.message.substr(0,250),line:tb.lineNumber,level:h,"client.name":Ic.name},postParams:{url:N("PAGE_NAME",
window.location.href),file:tb.fileName},method:"POST"};Ic.version&&($a["client.version"]=Ic.version);if($a.postParams){tb.stack&&($a.postParams.stack=tb.stack);for(var zk=u(Object.keys(Ic)),jg=zk.next();!jg.done;jg=zk.next()){var Ak=jg.value;$a.postParams["client."+Ak]=Ic[Ak]}var kg=Fh();if(kg)for(var Bk=u(Object.keys(kg)),lg=Bk.next();!lg.done;lg=Bk.next()){var Ck=lg.value;$a.postParams[Ck]=kg[Ck]}var Dk=N("SERVER_NAME"),Ek=N("SERVER_VERSION");Dk&&Ek&&($a.postParams["server.name"]=Dk,$a.postParams["server.version"]=
Ek)}qi(N("ECATCHER_REPORT_HOST","")+"/error_204",$a)}try{Gn.add(ra.message)}catch(uo){}Hn++}}}}}else throw Ub;}else console&&console.warn&&console.warn("The YouTube player is not attached to the DOM. API calls should be made after the onReady event. See more: https://developers.google.com/youtube/iframe_api_reference#Events")};function io(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
